...
const getDeliveryFullLabel = (value: string) => DELIVERY_MAP.get(value)?.fullLabel ?? DELIVERY_MAP.get(value)?.label ?? value
                            ...
                            <TooltipProvider>
                              <Tooltip>
                                <TooltipTrigger asChild>
                                  <button type="button" className={cn("inline-flex items-center justify-center gap-2 px-2 py-1 rounded-full text-[11px] font-medium", item.color, item.textColor)}>
                                    {item.label}
                                  </button>
                                </TooltipTrigger>
